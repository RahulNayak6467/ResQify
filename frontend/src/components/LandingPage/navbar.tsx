      ...
      <div className="flex items-center justify-between px-8 ">
        ...
        <nav className="p-4">
          <ul className="flex gap-8 items-center">
            ...
            <li>
              <button
                className="text-white bg-gradient-to-r from-critical to-accent font-bold text-[14px] px-4 py-1.5 border border-border rounded-lg shadow-[0_0px_20px_rgba(255,0,80,0.3)] hover:brightness-110 transition-all duration-200"
                type="button"
              >
                Sign Out
              </button>
